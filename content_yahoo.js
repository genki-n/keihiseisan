...
(function () {
  ...
  function isReceiptAnchor(anchor) {
    ...
    return /領収書|請求書|明細|発行する|ダウンロード/.test(t) || /receipt|invoice|pdf/i.test(href);
  }
  ...
  chrome.runtime.onMessage.addListener((msg, _sender, sendResponse) => {
    ...
    const urls = new Set();
    const cards = document.querySelectorAll('li, article, section, div[data-order-id], div[class*="order"]');
